...
# Global Constants #
#------------------#
pdf_folder       = "downloaded_pdfs_special"    # folder containing individual song PDFs
...
songBook         = "QRCC_Songbook_Special.pdf"  # name of the assembled (complete) songbook 
titlePage        = "title_page_special.pdf"     # name of the title page PDF
